...
Go to the [Secrets page](https://github.com/mildbyte/template-test-3/settings/secrets/actions/new) for this
...
going to https://github.com/mildbyte/template-test-3/actions/workflows/build.yml and clicking "Run workflow". 
